...
class PolicyPlayer(BasePlayer):
    def __init__(self):
        super().__init__()
        self.modelfile = r'C:\Users\you81\Documents\Tany\model\model_policy'
        self.model = None

    def usi(self):
        print('id name policy_player')
        print('optioon name modelfile type string default' + self.modelfile)
        print('usiok')
