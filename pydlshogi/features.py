...
def make_input_features_from_board(board):
    if board.turn == shogi.BLACK:
        ...
        piece_in_hand = (board.pieces_in_hand[shogi.BLACK], board.pieces_in_hand[shogi.WHITE])
    else:
        ...
        piece_in_hand = (board.pieces_in_hand[shogi.WHITE], board.pieces_in_hand[shogi.BLACK])

    return make_input_features(piece_bb, occupied, piece_in_hand)